...
const ProjectCard: FC<{ urlImage: string, name: string, description: string, projectID: string, route: string }> = ({ urlImage, name, description, projectID, route }) => {
    return (
        <Link href={`/${route}/${projectID}`} className="border bg-white shadow rounded-md p-4 max-w-[650px]">
            <div>
