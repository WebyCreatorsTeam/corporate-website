const ProjectCardSkeleton = () => {
    return (
        <div className="border bg-white border-blue-300 shadow rounded-md p-4 max-w-[650px]">
            <div className="animate-pulse space-x-4">
                <div>
                    <div className="min-h-72 min-w-[600px] overflow-hidden rounded-lg bg-slate-300"></div>
